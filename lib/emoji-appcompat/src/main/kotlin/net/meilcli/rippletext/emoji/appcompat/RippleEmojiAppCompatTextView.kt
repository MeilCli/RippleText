package net.meilcli.rippletext.emoji.appcompat
...
open class RippleEmojiAppCompatTextView : EmojiAppCompatTextView {

    private val presenter = RippleTextPresenter(this, this::createDrawableState)

    constructor(context: Context) : super(context) {
        context.withStyledAttributes(attrs = R.styleable.RippleEmojiAppCompatTextView) {
            val resourceId = getResourceId(R.styleable.RippleEmojiAppCompatTextView_textRipple, -1)
            if (resourceId != -1) {
    ...
    constructor(context: Context, attrs: AttributeSet?) : super(context, attrs) {
        context.withStyledAttributes(set = attrs, attrs = R.styleable.RippleEmojiAppCompatTextView) {
            val resourceId = getResourceId(R.styleable.RippleEmojiAppCompatTextView_textRipple, -1)
            if (resourceId != -1) {
                presenter.setRippleDrawable(resourceId)
            }
    ...
    constructor(context: Context, attrs: AttributeSet?, defStyleAttr: Int) : super(context, attrs, defStyleAttr) {
        context.withStyledAttributes(
            set = attrs,
            attrs = R.styleable.RippleEmojiAppCompatTextView,
